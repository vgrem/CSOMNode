...
SP.Publishing.ImageRendition.prototype = {
    ...
    writeToXml: function SP_Publishing_ImageRendition$writeToXml(writer, serializationContext) {
        ...
        SP.DataConvert.writeValueToXmlElement(writer, this.$O_1, serializationContext);
...
SP.Publishing.Navigation.NavigationTermProviderNameCollection.prototype = {
    ...
    $S_2: function SP_Publishing_Navigation_NavigationTermProviderNameCollection$$S_2($p0) {
        Array.add(this.get_data(), $p0);
    },
    
    $T_2: function SP_Publishing_Navigation_NavigationTermProviderNameCollection$$T_2() {
    ...
    $U_2: function SP_Publishing_Navigation_NavigationTermProviderNameCollection$$U_2($p0) {
