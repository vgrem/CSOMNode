...
SP.Utilities.Internal.ECBAdapter.prototype = {
    ...
    $1L_0: function SP_Utilities_Internal_ECBAdapter$$1L_0($p0, $p1) {
...
SP.SlapiInternal.ActivityEventHubResponseLog = function SP_SlapiInternal_ActivityEventHubResponseLog(pEventId, pEventTimestampUtc, pSucceeded) {
    this.EventId = pEventId;
    this.EventTimestampUtc = pEventTimestampUtc;
    this.Succeeded = pSucceeded;
};
SP.SlapiInternal.ActivityEventHubResponseLog.prototype = {
    EventId: null,
    EventTimestampUtc: null,
    Succeeded: false
};
SP.SlapiInternal.ActivityEventHubResponseLogNonAudit = function SP_SlapiInternal_ActivityEventHubResponseLogNonAudit(pEventId, pEventTimestampUtc, pSucceeded) {
    this.EventId = pEventId;
    this.EventTimestampUtc = pEventTimestampUtc;
    this.Succeeded = pSucceeded;
};
SP.SlapiInternal.ActivityEventHubResponseLogNonAudit.prototype = {
    EventId: null,
    EventTimestampUtc: null,
    Succeeded: false
};
...
SP.SlapiInternal.ActivityEventHubResponseLog.registerClass('SP.SlapiInternal.ActivityEventHubResponseLog');
SP.SlapiInternal.ActivityEventHubResponseLogNonAudit.registerClass('SP.SlapiInternal.ActivityEventHubResponseLogNonAudit');
