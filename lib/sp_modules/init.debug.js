...
function GetImageUrlWithRevision(imageUrl) {
    return imageUrl.search(/[?]/) > -1 ? imageUrl : imageUrl + "?" + "rev=41";
}
    ...
    if (g_PNGImageIds != null && useFilter) {
        for (var i = 0; i < g_PNGImageIds.length; i++) {
            ...
            if (img != null && g_PNGImageSources[i] != null) {
                ...
                img.src = "/_layouts/15/images/blank.gif?rev=41";
            }
        }
    }
}
    ...
    if (Boolean(obj)) {
        ...
        if (useFilter) {
            if (isPng) {
                ...
                obj.src = "/_layouts/15/images/blank.gif?rev=41";
            }
            else {
                obj.style.filter = "";
                obj.src = newImg;
...
function CreateSpinningWheelContainer() {
    ...
    waitingImg.src = "/_layouts/15/images/gears_anv4.gif?rev=41";
...
function _ribbonOnStartInit(ribbonInfo) {
    ...
    if (!bTabContainerExists && ribbonInfo.initialTabId != "Ribbon.Read") {
        ExecuteOrDelayUntilScriptLoaded(function() {
            ...
            _elmBlankTab.innerHTML = "<span class=\"ms-ribbontabswitchloading\"><img src=\"" + "/_layouts/15/images/loadingcirclests16.gif?rev=41" + "\" alt=\"\"/><span>" + Strings.STS.L_Loading_Text + "</span></span>";
...
function IsShortcutLink(listItem) {
    return Boolean(listItem) && (listItem["File_x0020_Type"] == "url" || listItem["File_x0020_Type"] == "website" || listItem["File_x0020_Type"] == "lnk");
}
...
function RenderShortcutLinkIcon(renderCtx, ret, content, listItem, listSchema) {
    ...
    ret.push(Encoding.HtmlEncode(Strings.STS.L_FieldType_File_Shortcut));
    ret.push("\" src=\"");
    ret.push(ListView.ImageBasePath + "/_layouts/15/images/icspgen.gif?rev=41");
    ret.push("\" />");
    ret.push("</a>");
}
